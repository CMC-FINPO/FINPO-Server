...
public class User {
    ...
    @Setter
    @Column(nullable = true, length = Constraint.NICKNAME_MAX_LENGTH)
    ...
    protected User(String name, String nickname, LocalDate birth, Gender gender, String email, Long statusId,
        String profileImg, OAuthType oAuthType) {
        this.name = name;
    ...
    public static User of(String name, String nickname, LocalDate birth, Gender gender, String email, Long statusId,
        String profileImg, OAuthType oAuthType) {
