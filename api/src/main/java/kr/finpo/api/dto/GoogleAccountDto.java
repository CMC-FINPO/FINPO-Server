...
public record GoogleAccountDto(
    ...
    public GoogleAccountDto of() {
        return new GoogleAccountDto(resourceName.substring(7), resourceName, etag, genders, birthdays, names,
            emailAddresses, photos);
    }
    ...
    public UserDto toUserDto() {
        ...
        try {
            birth = LocalDate.parse(
                String.format("%d-%02d-%02d", birthdays.get(0).date.year, birthdays.get(0).date.month,
                    birthdays.get(0).date.day));
        ...
        return new UserDto(
            ...
            null,
            birth,
            "male".equals(gender) ? kr.finpo.api.constant.Gender.MALE
                : "female".equals(gender) ? kr.finpo.api.constant.Gender.FEMALE : null,
            email,
            null,
            photo,
            OAuthType.GOOGLE,
