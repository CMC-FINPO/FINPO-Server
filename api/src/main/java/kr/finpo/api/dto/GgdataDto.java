  ...
  public record JobFndtnSportPolocyWrapper(
    ...
    public record Row(
      ...
      public Policy toEntity() {
        ...
        return Policy.of(PBLANC_TITLE.trim(), Integer.toString(PBLANC_TITLE.hashCode()), INST_NM, null, null, null, null, null, start, end, null, null, DETAIL_PAGE_URL, OpenApiType.GGDATA);
      }
    }
  }
}
