    ...
    public static class Emp {
        ...
        public Policy toEntity() {
            return Policy.of(
                polyBizSjnm.trim()
                , bizId.trim()
                , (cnsgNmor.trim().equals("-") || cnsgNmor.trim().contains("null")) ? ""
                    : cnsgNmor.trim().equals("주관기관과 동일") ? polyBizTy.trim() : cnsgNmor.trim()
                ...
                , (rqutUrla.trim().equals("-") || rqutUrla.trim().contains("null") || rqutUrla.trim().contains("없음")
                    || rqutUrla.trim().contains("미정")) ? "" : rqutUrla.trim()
